...
import { UserInfo } from '../Profiles/Profiles';
...
export const Questions = () => {
    ...
    const handleSend = async (item: PersonalNotification) => {
            const user: UserInfo = {
                id: undefined,
                role: item.role,
                name: '',
            ...
            if(role === 'lawyer') {
                ...
                user.name = item.lawyer.name;
                user.surname = item.lawyer.surname;
            } else {
        ...
        navigate('/adminPanel/privateNotifications', { state: { user, questionId: item.id, questionText: item.content } });
    };
        ...
        <div className="deal-history">
            ...
            {filteredData.length > 0 ? (
                ...
                <div className="empty-show">
                    ...
                    <img className="img-pro" src={`/static/empty-box.png`} alt="empty-box" />
                </div>
            )}
            <Pagination
