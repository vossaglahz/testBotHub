...
export const AboutThePlatform = () => {
    ...
    function SampleNextArrow(props: { className: string | undefined; style: CSSProperties | undefined; onClick: undefined }) {
        const { className, style, onClick } = props;
        return <div className={`${className} custom-arrow custom-next-arrow`} style={{ ...style, display: 'block' }} onClick={onClick} />;
    }

    function SamplePrevArrow(props: { className: string | undefined; style: CSSProperties | undefined; onClick: undefined }) {
        const { className, style, onClick } = props;
        return <div className={`${className} custom-arrow custom-prev-arrow`} style={{ ...style, display: 'block' }} onClick={onClick} />;
    }
    ...
    return (
        <Stack spacing={2} className="stack container" margin="50px" marginBottom="50px">
            ...
            <Box className="block-cards">
                <Slider className="sliderClass" arrows={true} {...settings}>
