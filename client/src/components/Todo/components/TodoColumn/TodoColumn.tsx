...
interface TodoColumnProps {
    ...
    onChangeStatus: (id: string, newStatus: StatusType) => void; // Новый обработчик
}
...
export const TodoColumn = ({ status, data, onDrop, onDeleteTodo, onChangeStatus }: TodoColumnProps) => {
