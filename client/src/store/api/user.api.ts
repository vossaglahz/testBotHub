...
import { ISubscribeLawyer } from '../../interfaces/ISubscribe.interface';

export const UserApi = createApi({
    reducerPath: 'userApi',
    baseQuery: fetchBaseQuery({
        baseUrl: `${import.meta.env.VITE_API_BACK_URL??"/api"}/users`,
        credentials: 'include',
    ...
    endpoints: build => ({
        ...
        subscribeLawyer: build.mutation<
            ISubscribeLawyer,
            { id: number | undefined; dateSubscription?: string | null;}
        >({
            query: data => ({
                url: '/admin/subscribeLawyer',
                method: 'POST',
                body: data,
            }),
        }),
